    ...
    public function store(Request $request)
    {
        $data = $this->validate(
            ...
            [
              ...
              //  'image' => 'required|image|mimes:png,jpg,jpeg,pdf|max:500',
            ],
            [
                ...
                'details.required' => 'O campo Detalhe deve ser selecionado',
    ...
    public function update(Request $request, $id)
    {
        $data = $request->validate(
            [
                ...
                'season' => 'required',
                'details' => 'required',
              //  'image' => 'required|image|mimes:png,jpg,jpeg,pdf|dimensions:min_width=100,min_height=100,max_width=500,max_height=500|max:500',
            ],
            [
                'fk_courses_id.required' => 'O campo Curso deve ser selecionado',
                'fk_classes_id.required' => 'O campo Turma deve ser selecionado',
