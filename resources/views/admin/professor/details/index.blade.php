                        ...
                        <div class="col-12">
                            ...
                            <div class="row justify-content-between mb-4">
                                ...
                                <div class="col-12 col-md-4 col-lg-4 text-right mt-5">
                                    <a href="{{ route('admin.professor.edit', $professor->id) }}"
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    ...
                                    <p class="text-dark">{{ $professor->nProcess }}</p>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    ...
                                    <p class="text-dark">{{ $professor->nBi }}</p>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    ...
                                    <p class="text-dark">{{ $professor->email }}</p>
                                </div>
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    ...
                                    <p class="text-dark">{{ $professor->dateBirth }}</p>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    <h5>
                                        <b class="mb-1">Contacto do Aluno / Alternativo</b>
                                    </h5>
                                    <p class="text-dark">{{ $professor->contact }} / {{ $professor->contactAlter }}</p>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    <h5>
                                        <b class="mb-1">Nome do Pai</b>
                                    </h5>
                                    <p class="text-dark">{{ $professor->father }}</p>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    <h5>
                                        <b class="mb-1">Nome da Mâe</b>
                                    </h5>
                                    <p class="text-dark">{{ $professor->mother }}</p>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4 mb-2">
                                    <h5>
                                        <b class="mb-1">Ano lectivo</b>
                                    </h5>
                                    <p class="text-dark">{{ $professor->schoolyear }}</p>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-7 mb-2">
                                    <hr>
                                    <p class="mb-1 text-dark"><b>Data de Cadastro</b> {{ $professor->created_at }}
                                    </p>
                                    <p class="mb-1 text-dark"><b>Última Actualização</b> {{ $professor->updated_at }}
                                    </p>
