...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.home') }}">
        ...
        <div class="sidebar-brand-text mx-3">Gestão Escolar - Admin</div>
    </a>
 ...
 <!-- Nav Item - Pages Collapse Menu -->
  ...
  <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseProfAllt"
            aria-expanded="true" aria-controls="collapseProfAll">
            <i class="fas fa-fw fa-user"></i>
            <span>Inscrição de Professor</span>
        </a>
        <div id="collapseProfAllt" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">

                <a class="collapse-item $active"
                    href="{{ route('admin.professor.create') }}">Cadastrar</a>
                <a class="collapse-item $active"
                    href="{{ route('admin.professor.list') }}">Listar</a>
            </div>
        </div>
    </li>
