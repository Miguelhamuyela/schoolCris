...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['registrador'])->group(function () {
        ...
        /** professor   */
        Route::get('/admin/professor/list', ['as' => 'admin.professor.list', 'uses' => 'Admin\ProfessorController@index']);
        Route::post('/admin/professor', ['as' => 'admin.professor.store', 'uses' => 'Admin\ProfessorController@store']);
        Route::get('/admin/professor/create', ['as' => 'admin.professor.create', 'uses' => 'Admin\ProfessorController@create']);
        Route::get('/admin/professor/show/{id}', ['as' => 'admin.professor.show', 'uses' => 'Admin\ProfessorController@show']);
        Route::post('/admin/professor/update/{id}', ['as' => 'admin.professor.update', 'uses' => 'Admin\ProfessorController@update']);
        Route::delete('/admin/professor/destroy/{id}', ['as' => 'admin.professor.destroy', 'uses' => 'Admin\ProfessorController@destroy']);
        Route::get('/admin/professor/edit/{id}', ['as' => 'admin.professor.edit', 'uses' => 'Admin\ProfessorController@edit']);
        /** End professor   */
    ...
    Route::middleware(['gerenciador'])->group(function () {
        ...
        Route::get('/pdf/professor/', ['as' => 'pdf.professor', 'uses' => 'Admin\PDFController@professor']);
